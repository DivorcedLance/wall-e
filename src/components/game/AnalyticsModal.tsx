...
import { BarChart3, TrendingUp, Clock, AlertTriangle, Download } from "lucide-react";
    ...
    <div className="space-y-0.5">
      <div className="flex items-center justify-between text-[10px]">
        ...
        <div className="flex items-center gap-1">
          ...
          {status === "danger" && <Badge variant="destructive" className="text-[8px] px-1 py-0 h-3.5">REEMPLAZAR</Badge>}
          {status === "warning" && <Badge variant="outline" className="text-[8px] px-1 py-0 h-3.5 border-accent text-accent">REVISAR</Badge>}
        </div>
      </div>
        ...
        <div className="space-y-3 max-h-[65vh] overflow-y-auto scrollbar-thin pr-1">
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="rounded-lg border border-border bg-card p-3 text-center">
              ...
              <div className="text-[10px] text-muted-foreground mt-0.5">m² Promedio Mensual</div>
              <div className="flex items-center justify-center gap-0.5 mt-1">
                <TrendingUp className="h-3 w-3 text-primary" />
                <span className="text-[10px] text-primary font-medium">+6.2% vs. período anterior</span>
              </div>
            </div>
            <div className="rounded-lg border border-border bg-card p-3 text-center">
              <div className="text-2xl font-bold text-foreground">99.4%</div>
              <div className="text-[10px] text-muted-foreground mt-0.5">Uptime Promedio</div>
              <div className="flex items-center justify-center gap-0.5 mt-1">
                <TrendingUp className="h-3 w-3 text-primary" />
                <span className="text-[10px] text-primary font-medium">+0.2pp — cerca del SLA</span>
              </div>
            </div>
            <div className="rounded-lg border border-border bg-card p-3 text-center">
              <div className="text-2xl font-bold text-foreground">14</div>
              <div className="text-[10px] text-muted-foreground mt-0.5">Incidentes Totales</div>
              <div className="flex items-center justify-center gap-0.5 mt-1">
                <TrendingUp className="h-3 w-3 text-primary rotate-180" />
                <span className="text-[10px] text-primary font-medium">−23% vs. semestre anterior</span>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border bg-card p-3 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium">m² Procesados por Mes</span>
            ...
            <div className="flex justify-between text-[9px] text-muted-foreground">
              <span>0K</span><span>45K</span><span>90K</span><span>135K</span><span>180K</span>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border bg-card p-3 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium">Uptime del Sistema — SLA 99.5%</span>
            </div>
            ...
            <div className="flex justify-between text-[9px] text-muted-foreground">
              <span>98.5%</span><span>99.5%</span><span>100%</span>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-border bg-card p-3 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium">Horas de Operación — Semana Actual</span>
              <Button size="sm" variant="ghost" className="h-6 text-[10px] px-2">
                <Download className="h-3 w-3 mr-1" />
                Exportar Reporte OpEx
              </Button>
            </div>
          ...
          <div className="rounded-lg border border-border bg-card p-3 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium">Mantenimiento Predictivo — Desgaste de Cuchillas</span>
              <span className="text-[10px] text-muted-foreground">Límite: {BLADE_LIMIT} h</span>
            </div>
            ...
            <div className="flex items-start gap-2 rounded-lg border border-accent/30 bg-accent/5 p-2 mt-1">
